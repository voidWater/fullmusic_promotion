<template>
  <div class="hello">
	 <div>
		<mt-swipe :auto="4000" class="banner-wrap">
		  <mt-swipe-item class="banner-item">
			<img class="img-bar" src="../assets/0.jpg">
		  </mt-swipe-item>
		  <mt-swipe-item class="banner-item">
	 ...
	 <div class="content">
		...
		<div class="biv">
			<div><img class="img" src="../assets/兔子.png"><div class="title">部分教师简介</div></div>
			<div>
				<img class="ls_img" src="../assets/ls_1.jpg">
			</div>
			<div>
				<img class="ls_img" src="../assets/ls_2.jpg">
			</div>
			<div>
				<img class="ls_img" src="../assets/ls_3.jpg">
			</div>
			<div>
				<img class="ls_img" src="../assets/ls_5.jpg">
			</div>
			<div>
				<img class="ls_img" src="../assets/ls_6.jpg">
			</div>
			<div>
				<img class="ls_img" src="../assets/ls_4.jpg">
			</div>
		</div>
		<div class="biv">
			<div><img class="img" src="../assets/兔子.png"><div class="title">学生风采</div></div>
			<div>
				<img class="ls_img" src="../assets/xs_1.jpg">
			</div>
			<div>
				<img class="ls_img" src="../assets/xs_2.jpg">
			</div>
		</div>
	 </div>	
	 <div class="bar"></div>
